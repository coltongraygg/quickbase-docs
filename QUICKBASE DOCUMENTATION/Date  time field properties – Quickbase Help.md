...
Quickbase date and time fields display in the following format: 07-08-2012 03:45 PM. To format the date differently, select one or more of the following checkboxes:
...
The time and the date. For example, 07-08-2012 03:45 PM.

Note: Quickbase turns on this option automatically. It's the default.
...
The time zone after the date and time. For example, 07-08-2012 03:45 PM (PST).
