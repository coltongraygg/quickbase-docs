...
Under Maps to this Quickbase field, select a Quickbase field that you want to map to a vCard field.

Note: You must map vCard fields with an asterisk (\*) to Quickbase fields.

For example, under Maps to this Quickbase field, you can map the vCard Cell Phone field to one of the available Quickbase fields. Don't see the field you want? That's because each item in the list accepts only fields of a specific data type.

Related Topic:

-   [Set Up a vCard Field](https://helpv2.quickbase.com/hc/en-us/articles/4570136812820-Set-Up-a-vCard-Field-)
